...
alert("MemberProfile: Component mounted"); // ADD THIS LINE
...
const MemberProfile = () => {
  ...
  console.log("MemberProfile: useEffect triggered");
   ...
   console.log("MemberProfile: Token from localStorage:", token);  // Log the token
   alert(`Token: ${token}`); // Display the token in an alert (FOR DEBUGGING ONLY)
  ...
  if (!member) return <p>Loading memberprofile ...</p>;
